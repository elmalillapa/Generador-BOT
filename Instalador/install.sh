...
SCPT_DIR="/etc/SCRIPT"
rm -f gera*
source <(curl -sSL https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Otros/msg) >/dev/null
#!/bin/bash
...
[[ -d /bin/ejecutar ]] && {
    [[ -e /bin/ejecutar/msg ]] || wget -q -O /bin/ejecutar/msg https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Otros/msg
} || mkdir /bin/ejecutar
cor[0]="\033[0m"
cor[1]="\033[1;34m"
cor[2]="\033[1;32m"
...
function_verify() {
    ...
    [[ -z $keybot ]] && {
        ...
        permited=$(curl -sSL "https://raw.githubusercontent.com/elmalillapa/Multi-Script/main/ChuGH-5.7u/Bot/Control-Bot")
    } || {
        permited=$(curl -sSL "https://raw.githubusercontent.com/elmalillapa/Multi-Script/main/ChuGH-5.7u/Bot/Control-Bot")
    ...
    [[ $(echo $permited | grep "${IP}") = "" ]] || {
        ...
        [[ -e /usr/bin/downBase ]] || echo 'https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Otros/lista' >/usr/bin/downBase && chmod 777 /usr/bin/downBase
        v1=$(curl -sSL "https://raw.githubusercontent.com/elmalillapa/Multi-Script/main/ChuGH-5.7u/adm-lite/v-local.log")
        [[ ! -e /bin/downloadbot ]] && {
        ...
        [[ -e /usr/bin/downBase ]] || echo 'https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Otros/lista' >/usr/bin/downBase && chmod 777 /usr/bin/downBase
        [[ -e /bin/ShellBot.sh ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Otros/ShellBot.sh >/dev/null && chmod +rwx /bin/ShellBot.sh
...
fun_filez() {
    ...
    wget -O /bin/http-server.sh https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Bot/http-server.py  && chmod +x /bin/http-server.sh
...
DOWS() {
    wget -O /root/lista https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Otros/lista
...
atualiza_fun() {
    ...
    wget -q -O /usr/bin/gerar https://raw.githubusercontent.com/elmalillapa/Generador-BOT/main/Menu-Bash/gerador.sh && chmod +rwx /usr/bin/gerar
    cd $HOME
    msg -bar
